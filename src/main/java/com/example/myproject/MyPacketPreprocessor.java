 ...
 * <p>
 * This is specified in the configuration file yamcs.fdirdemo.yaml:
 *
 * <pre>
 * ...
 * dataLinks:
 ...
 *     host: localhost
 *     port: 10015
 *     packetPreprocessorClassName: com.example.fdirdemo.MyPacketPreprocessor
 * ...
 * </pre>
 */
public class MyPacketPreprocessor extends AbstractPacketPreprocessor {
    ...
    public TmPacket process(TmPacket packet) {
        ...
        if (bytes.length < 5) { // Expect at least the length of CCSDS primary header
            eventProducer.sendWarning("SHORT_PACKET",
                    "Short packet received, length: " + bytes.length + "; minimum required length is 5 bytes.");
        ...
        packet.setSequenceCount(counter++);
